            ...
            <div class="col-md-12">
                <ul class="list-group">
                    <li class="list-group-item active">
                        <br>
                        <p>Hallo {{Auth::user()->name}}, Berikut ini data Daily Report Sales : {{$getname->name}}. <br><br>
                        ...
                        <table class="table w-100">
                            <thead>
                                <tr >
                                    ...
                                    <th style="min-width:200px;" class="text-center">Harga Bandwith <br> Tanpa PPN</th>
                                    <th style="min-width:80px;" class="text-center">PPN ( % )</th>
                                    <th style="min-width:200px; background-color:#1bb1e7;color:#fff;" class="text-center">Total Harga + <br> PPN ( Rp. )</th>
